...
<main>
  ...
  <section id="section1">
    <div class="container">
      ...
      <p>これはメインカラーのテキストです。これはメインカラーのテキストです。これはメインカラーのテキストです。<span class="u-txt-primary">これはプライマリーカラーのテキストです。これはプライマリーカラーのテキストです。これはプライマリーカラーのテキストです。</span><span class="u-txt-secondary">これはセカンダリーカラーのテキストです。これはセカンダリーカラーのテキストです。これはセカンダリーカラーのテキストです。</span><span class="u-txt-error">この色は危険です。この色は危険です。この色は危険です。</span></p>
    </div>
  </section>
