 ...
 * スタイルカスタマイザー
 */
if (!class_exists('Sample_StyleCustomize')) {

  class Sample_StyleCustomize {
    ...
    public static function register($wp_customize) {
      ...
      $wp_customize->add_setting('main_bgcolor', array('default' => '#f5f5f5'));
  ...
  add_action('customize_register', array('Sample_StyleCustomize', 'register'));
}
